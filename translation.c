...
void print_acc(Instruction instruction) {
     printf(RTYPE_FORMAT, "acc", instruction.rtype.rd, instruction.rtype.rs1, 
        instruction.rtype.rs2);
}